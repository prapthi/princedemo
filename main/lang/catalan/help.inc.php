...
<hr noshade=\"\" size=\"1\">";
$langExerciseContent = "L'eina 'Exercicis' li permet crear exercicis que han de contenir tantes preguntes com vostè vulgui.
...
$langPathContent = "L'eina 'Exercicis' li permet crear exercicis que han de contenir tantes preguntes com vostè vulgui.
...
$langDescriptionContent = "Aquesta eina l'ajudarà a descriure el seu curs d'una forma sintètica. Aquesta descripció donarà als estudiants una idea del que poden esperar del curs. Així mateix, el pot ajudar a repensar l'escenari educatiu proposat.
...
$langLinksContent = "Aquesta eina permet als professors oferir una biblioteca de recursos als seus estudiants.
...
$langMycoursesContent = "Un cop autenticat a la plataforma, se troba dins de la seva <i>àrea d'usuari</i>.
...
$langAgendaContent = "L'agenda és una eina que en cada curs ofereix una visió resumida de les activitats proposades. Aquesta eina també és accessible a la barra superior mitjançant la opció '' Agenda ', encara que aquí ofereix una síntesi de tots els esdeveniments relatius a tots els cursos en què l'usuari està inscrit. Aquesta segona funcionalitat sempre estarà disponible.
...
$langChatContent = "L'eina 'Xat' li permet xerrar en viu amb diversos membres del curs.
...
$langTrackingContent = "L'eina 'Estadístiques' l'ajuda a fer un seguiment de l'evolució dels usuari del curs. Aquest es pot realitzar a dos nivells:
...
$langHSettings = "Ajuda: configuració del curs";
$langSettingsContent = "Aquesta eina us permet gestionar els paràmetres del seu curs: Títol, codi, idioma, nom dels professors, etc.
...
$langHExternal = "Ajuda: afegir un enllaç extern";
$langExternalContent = "Chamilo té una estructura modular. Ens permet mostrar o ocultar les eines, en funció del disseny inicial del nostre projecte pedagògic o al llarg de les seves diferents fases cronològiques. En aquesta línia, la plataforma també permet afegir directament enllaços a la pàgina principal del lloc web del seu curs. Aquests enllaços poden ser de dos tipus:
...
$langClarContent3 = "<b>Teoria educativa</b>

Per als professors, preparar un curs a Internet és principalment una qüestió de Teoria Educativa.";
$langClarContent4 = "estan a la seva disposició per ajudar terme durant els passos de l'evolució del seu projecte de formació: des eldiseño de les eines a la seva integració en una estratègia coherentey clara amb una avaluació del seu impacte en l'aprenentatge dels estudiants.";
$langClarContent1 = "Esborra el contingut";
$langClarContent2 = "Esborra el contingut";
$langHGroups = "Ajuda: grups";
$langGroupsContent = "Aquesta eina us permet crear àrees per a grups d'estudiants i assignar dues eines de col·laboració: un fòrum de debat i una secció de documentació comuna on poden compartir, pujar i organitzar els seus propis arxius (independent del mòdul Documents, exclusiu per a professors i tutors). L'àrea de documents és privada, i el fòrum pot ser
públic o privat.

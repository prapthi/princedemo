...
$langPpt2lp = "Oogie";
$langPpt2lpDescription = "PowerPoint2LearningPath vous permet de transformer en quelques clics de souris une présentation PowerPoint ou Libre/OpenOffice en un parcours d'apprentissage.";
$langBandWidthStatistics = "Bandwidth statistics";
$langBandWidthStatisticsDescription = "MRTG vous permet de consulter les statistiques détaillées de l'état de votre serveur sur les dernières 24 heures.";
...
$PortalSessionsLimitReached = "Désolé, cette installation de Chamilo est limitée en nombre de sessions, et la limite a été atteinte. Pour augmenter le nombre de sessions autorisées sur cette installation, veuillez contacter votre fournisseur ou, si l'option est disponible, passer à un plan supérieur.";

...
$langOogieConversionPowerPoint = "Prince education system RAPID : PowerPoint conversion";
...
$Options = "Options";
$WelcomeOogieConverter = "Welcome to Prince education system RAPID<ul type=\"1\"><li>Browse your hard disk to find any .ppt or .odp file<li>Upload it to Oogie. It will tranform it into a Scorm course.<li>You will then be allowed to add audio comments on each slide and insert test and activities between the slides.";
...
$TemplateTitleMrDokeos = "Mr Prince education system little explaining";
$TemplateTitleMrDokeosDescription = "Dialog on the bottom with Mr Prince education system";
...
$HelpFolderLearningPaths = "INFORMATION VISIBLE TO THE TEACHER ONLY:\nThis folder contains documents which are created by the Learning Path tool. Inside this folder you can edit the HTML file which are generated by importing content from the Learning Path, as the ones imported by Prince education system Rapid, for example. We recommend hiding this folder to your students.";
...
$HelpGoogleAudio = "Supports up to 100 characters in a wide variety of languages. The files are generated and automatically saved into the Prince education system directory where you currently are.";
...
$HelpPediaphon = "Supports text with several thousands characters, in various types of male and female voices (depending on the language). Audio files will be generated and automatically saved to the Prince education system directory in which you are.";

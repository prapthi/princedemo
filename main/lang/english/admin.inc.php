...
*/
$CasMainActivateComment = "Enabling CAS authentication will allow users to authenticate with their CAS credentials.<br/>Go to <a href='settings.php?category=CAS'>Plugin</a> to add a configurable 'CAS Login' button for your Prince education system campus.";
...
$DokeosClassic = "Prince education system classic";
...
$DokeosAdminWebLinks = "Prince education system Web";
...
$langUpgrade = "Upgrade Prince education system";
$langWebsite = "Prince education system website";
...
$langYourDokeosUses = "Your Prince education system installation uses presently";
...
$PlatformLanguages = "Prince education system Portal Languages";
...
$DokeosFolder = "Prince education system folder";
...
$SiteNameComment = "The Name of your Prince education system Portal (appears in the header)";
...
$ShowStudentViewComment = "Enable Student View?<br>This feature allows the teacher to see the learner view.";
$AllowGroupCategories = "Group categories";
$AllowGroupCategoriesComment = "Allow teachers to create categories in the Groups tool?";
$PlatformLanguageComment = "You can determine the platform languages in a different part of the platform administration, namely: <a href=\"languages.php\">Prince education system Platform Languages</a>";
...
$Learnpath = "Courses";
$Exercises = "Tests";
$AllowPersonalAgendaTitle = "Personal Time table";
$AllowPersonalAgendaComment = "Can the learner add personal events to the Time table?";
...
$DokeosHomepage = "Prince education system website";
...
$DefaultDokeosStyle = "Default Prince education system style";
...
$PleaseVisitDokeos = "Please visit the Prince education system website";
...
$langConfigureExtensions = "Prince education system PRO";
$langActiveExtensions = "Activate this service";
$langVisioconf = "Prince education system LIVE";
$langVisioconfDescription = "Prince education system LIVE is a videoconferencing tool that offers: Slides sharing, whiteboard to draw and write on top of slides, audio/video duplex and chat. It requires Flash® player 9+ and offers 2 modes : one to many and many to many.";
$langPpt2lp = "Prince education system RAPID";
$langPpt2lpDescription = "Prince education system RAPID is a Rapid Learning tool available in Prince education system Pro and Prince education system Medical. It allows you to convert Powerpoint presentations and their Openoffice equivalents to SCORM-compliant e-courses. After the conversion, you end up in the Courses authoring tool and are able to add audio comments on slides and pages, tests and activities between the slides or pages and interaction activities like forum discussions or assigment upload. Every step becomes an independent and removable learning object. And the whole course generates accurate SCORM reporting for further coaching.";
...
$SearchEngine = "Prince education system LIBRARY";
$langSearchEngineDescription = "Prince education system LIBRARY is a Search Engine offering multi-criteria indexing and research. It is part of the Prince education system Medical features.";
...
$PublicPagesComplyToWAIComment = "WAI (Web Accessibility Initiative) is an initiative to make the web more accessible. By selecting this option, the public pages of Prince education system will become more accessible. This also means that some content on the portal's public pages might appear differently.";
...
$YesAddCSVHeader = "Yes, add the CSV header<br />This line defines the fields and is necessary when you want to import the file in a different Prince education system portal";
...
$EphorusDescription = "Start using the Ephorus anti plagiarism service in Prince education system.<br /> \t\t\t\t\t\t\t\t\t\t\t\t\t\t<strong>With Ephorus, you will prevent internet plagiarism without any additional effort.</strong><br /> \t\t\t\t\t\t\t\t\t\t\t\t\t\t You can use our unique open standard webservice to build your own integration or you can use one of our Prince education system-integration modules.";
...
$PlatformCharsetComment = "The character set is what pilots the way specific languages can be displayed in Prince education system. If you use Russian or Japanese characters, for example, you might want to change this. For all english, latin and west-european characters, the default UTF-8 should be alright.";
...
$LDAPFilledTutorFieldComment = "A check will be done on this LDAP contact field on new users insertion. If this field is not empty, the user will be considered as a tutor and inserted in Prince education system as such. If you want all your users to be recognised as simple users, leave this field empty. You can modify this behaviour by changing the code. Please read the <a href=\"../../documentation/installation_guide.html\">installation guide</a> for more information.";
...
$Templates = "Templates";
$HideCampusFromPublicDokeosPlatformsList = "Do not display my portal in the list of Prince education system portals";
...
$DokeosClassic2D = "Prince education system classic 2D";
$DokeosBlue = "Prince education system blue";
...
$MathMimetexComment = "Enable mimeTeX mathematical editor. The activation is not fully realized if not previously installed on the server the executable MimeTex file. See the Prince education system installation guide.";
...
$Username = "Username";
$ChamiloHomepage = "Prince education system homepage";
$ChamiloForum = "Prince education system forum";
$ChamiloExtensions = "Prince education system extensions";
$ImpossibleToContactVersionServerPleaseTryAgain = "Impossible to contact the version server right now. Please try again later.";
$ChamiloGreen = "Prince education system Green";
$ChamiloRed = "Prince education system red";
...
$PortalSessionsLimitReached = "Sorry, this installation has a sessions limit, which has now been reached. To increase the number of sessions allowed on this Prince education system installation, please contact your hosting provider or, if available, upgrade to a superior hosting plan.";
$PortalCoursesLimitReached = "Sorry, this installation has a courses limit, which has now been reached. To increase the number of courses allowed on this Prince education system installation, please contact your hosting provider or, if available, upgrade to a superior hosting plan.";
$PortalTeachersLimitReached = "Sorry, this installation has a teachers limit, which has now been reached. To increase the number of teachers allowed on this Prince education system installation, please contact your hosting provider or, if available, upgrade to a superior hosting plan.";
$PortalUsersLimitReached = "Sorry, this installation has a users limit, which has now been reached. To increase the number of users allowed on this Prince education system installation, please contact your hosting provider or, if available, upgrade to a superior hosting plan.";
...
$chamilo = "Prince education system";
$php = "PHP";
$Off = "Off";
$minimum = "minimum";
...
$CourseDescriptionUpdated = "Subject description updated";
...
$EnableCourseValidationComment = "When the \"Courses validation\" feature is enabled, a teacher is not able to create a course alone. He/she fills a course request. The platform administrator reviews the request and approves it or rejects it.<br />This feature relies on automated e-mail messaging; set Prince education system to access an e-mail server and to use a dedicated an e-mail account.";
$CourseValidationTermsAndConditionsLink = "Course validation - a link to the terms and conditions";
$CourseValidationTermsAndConditionsLinkComment = "This is the URL to the \"Terms and Conditions\" document that is valid for making a course request. If the address is set here, the user should read and agree with these terms and conditions before sending a course request.<br />If you enable Prince education system's \"Terms and Conditions\" module and if you want its URL to be used, then leave this setting empty.";
$EnableSSOTitle = "Single Sign On";
$EnableSSOComment = "Enabling Single Sign On allows you to connect this platform as a slave of an authentication master, for example a Drupal website with the Drupal-Prince education system plugin or any other similar master setup.";
$SSOServerDomainTitle = "Domain of the Single Sign On server";
$SSOServerDomainComment = "The domain of the Single Sign On server (the web address of the other server that will allow automatic registration to Prince education system). This should generally be the address of the other server without any trailing slash and without the protocol, e.g. www.example.com";
...
$SSOServerUnAuthURIComment = "The address of the page on the server that logs the user out. This option is useful if you want users logging out of Prince education system to be automatically logged out of the authentication server.";
...
$EnabledWirisComment = "Enable WIRIS mathematical editor. Installing this plugin you get WIRIS editor and WIRIS CAS. <br/>This activation is not fully realized unless it has been previously downloaded the <a href=\"http://www.wiris.com/plugins/editors/download?filter=fckeditor\" target=\"_blank\">PHP plugin for FCKeditor WIRIS</a> and unzipped its contents in the Prince education system's directory main/inc/lib/fckeditor/editor/plugins/fckeditor_wiris/ <br/>This is necessary because Wiris is proprietary software and his services are <a href=\"http://www.wiris.com/store/who-pays\" target=\"_blank\">commercial</a>. To make adjustments to the plugin, edit configuration.ini file or replace his content by configuration.ini.default Prince education system file.";
...
$BigBlueButtonSecuritySaltComment = "This is the security key of your BigBlueButton server, which will allow your server to authentify the Prince education system installation. Refer to the BigBlueButton documentation to locate it.";
...
$YouAreUsingChamiloInAWindowsPlatformSadlyYouCantConvertDocumentsInOrderToSearchTheContentUsingThisTool = "You are using Prince education system in a Windows platform, sadly you can't convert documents in order to search the content using this tool";
...
$AllowBrowserSnifferComment = "This will enable an investigator of the capabilities that support browsers that connect to Prince education system. Therefore will improve user experience by adapting responses to the type of browser platform that connects, but will slow initial page load of users every time that they enter to the platform.";
...
$ShibbolethMainActivateComment = "<p>First of all, you have to configure Shibboleth for your web server.</p>To configure it for Prince education system<h5>edit file main/auth/shibboleth/config/aai.class.php</h5><p>Modify object &#36;result values with the name of your Shibboleth attributes</p><ul><li>&#36;result-&gt;unique_id = 'mail';</li><li>&#36;result-&gt;firstname = 'cn';</li><li>&#36;result-&gt;lastname = 'uid';</li><li>&#36;result-&gt;email = 'mail';</li><li>&#36;result-&gt;language = '-';</li><li>&#36;result-&gt;gender = '-';</li><li>&#36;result-&gt;address = '-';</li><li>&#36;result-&gt;staff_category = '-';</li><li>&#36;result-&gt;home_organization_type = '-'; </li><li>&#36;result-&gt;home_organization = '-';</li><li>&#36;result-&gt;affiliation = '-';</li><li>&#36;result-&gt;persistent_id = '-';</li><li>...</li></ul><br/>Go to <a href='settings.php?category=Shibboleth'>Plugin</a> to add a configurable 'Shibboleth Login' button for your Prince education system campus.";
$LdapDescriptionTitle = "<h3>LDAP autentication</h3>";
$FacebookMainActivateTitle = "<h3>Facebook authentication</h3>";
$FacebookMainActivateComment = "<p>First of all, you have create a Facebook Application (see <a href='https://developers.facebook.com/apps'>https://developers.facebook.com/apps</a>) with your Facebook account. In the Facebook Apps parameters, the site URL value should have a GET parameter 'action=fbconnect' (e.g. http://mychamilo.com/?action=fbconnect).</p>Then, <h5>edit file main/auth/external_login/facebook.conf.php</h5>and enter 'appId' and 'secret' values for &#36;facebook_config.<br/>Go to <a href='settings.php?category=Facebook'>Plugin</a> to add a configurable 'Facebook Login' button for your Prince education system campus.";
...
$ChamiloOfficialServicesProviders = "Prince education system official services providers";
$Reader = "Reader";
$Zombies = "Zombies";

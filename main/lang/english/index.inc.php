...
$ViewOpenClasses = "View open Classes";
...
$CourseView = "Display the full list of the Classes";
...
<p>As you can see, your Classes list is still empty. That's because you are not registered to any course yet! </p>";
$PleaseAllowUsALittleTimeToSubscribeYouToOneOfOurClasses = "Please allow us a little time to subscribe you to one of our Classes. If you think we forgot you, contact the portal administrators. You can usually find their contact details in the footer of this page.";
$Profile = "Profile";
?>
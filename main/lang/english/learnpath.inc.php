...
$LearnPathAddedTitle = "Welcome to the Prince education system course authoring tool !";
...
$LearnpathAddLearnpath = "Create new learning resource";
...
$langItemMissing2 = "page (step) here in the original Prince education system Learning Path.";
$langDone = "Done";
...
$AddLpIntro = "<strong>Welcome</strong> to the Prince education system Course authoring tool.<br />Create your courses step-by-step. The table of contents will appear to the left.";
$AddLpToStart = "To start, give a title to your lesson";
...
$LPCreateDocument = "Add this resource to the lesson";
